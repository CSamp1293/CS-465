...
export class Authentication {
  ...
  // NOTE: Uncomment the the two console.log messages for additional debugging information.
  ...
  // Because that method returns an observable, we subscribe to this result and only process when the Observable condition is satisfied.
  // NOTE: Uncomment the two console.log messages for additional debugging information.
  ...
  // Retrieve the current user. This function should only be called after the calling method has checked
